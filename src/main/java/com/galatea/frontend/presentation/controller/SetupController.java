...
import com.galatea.frontend.presentation.view.SetupPanel;
...
public class SetupController implements ActionListener {
    ...
    public SetupController(MainWindow view) {
        this.view = view;
    }
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        switch (command) {
            case SetupPanel.PROJECT_PATH -> view.getProjectPath();
            case SetupPanel.FEATURE_PATH -> view.getFeaturePath();
        }
    }
}
